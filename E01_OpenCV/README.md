...
원본 이미지와 변환된 이미지를 가로로 나란히 출력하는 프로그램을 구현합니다.
...
마우스를 사용하여 이미지 위에 그림을 그릴 수 있는 프로그램을 구현합니다.  
키보드 입력을 통해 붓 크기를 조절할 수 있도록 합니다.
...
마우스를 이용하여 이미지에서 관심 영역(ROI)을 선택하고  
선택한 영역을 출력하거나 저장하는 프로그램을 구현합니다.
